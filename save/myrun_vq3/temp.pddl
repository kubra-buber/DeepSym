(define (domain stack)
	...
	(:action stack0
		...
		:precondition (and (not (stacked)) (not (inserted)) (pickloc ?above) (stackloc ?below) (or (objtype0 ?below) (objtype1 ?below)) (or (objtype0 ?above) (objtype2 ?above)) (or (relation0 ?below ?above) (relation1 ?below ?above)))
		:effect (and (probabilistic
				 0.397 (move1)
				 0.100 (move2)
				 0.198 (and (inserted) (instack ?above) (stackloc ?above) (not (stackloc ?below)))
				 0.150 (move2)
				 0.155 (roll)
	...
	(:action stack1
		:parameters (?below ?above)
		:precondition (and (not (stacked)) (not (inserted)) (pickloc ?above) (stackloc ?below) (or (objtype0 ?below) (objtype1 ?below)) (or (objtype1 ?above) (objtype3 ?above)) (or (relation0 ?below ?above) (relation1 ?below ?above)))
		:effect (and (probabilistic
				 0.220 (move1)
				 0.000 (move2)
	...
	(:action stack2
		...
		:effect (and (probabilistic
				 ...
				 0.021 (move2)
				 0.202 (roll)
				 0.616 (and (stacked) (inserted) (instack ?above) (stackloc ?above) (not (stackloc ?below))))
				(not (pickloc ?above)))
	)
	(:action stack3
		:parameters (?below ?above)
		:precondition (and (not (stacked)) (not (inserted)) (pickloc ?above) (stackloc ?below) (or (objtype2 ?below) (objtype3 ?below)) (or (objtype1 ?above) (objtype3 ?above)) (or (relation0 ?below ?above) (relation1 ?below ?above)))
		:effect (and (probabilistic
				 0.098 (move1)
				 0.002 (move2)
				 ...
				 0.042 (move2)
				 0.232 (roll)
				 0.618 (and (stacked) (inserted) (instack ?above) (stackloc ?above) (not (stackloc ?below))))
				(not (pickloc ?above)))
	)
